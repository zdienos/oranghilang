<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <?= form_open('user/update/'.$detail->id, array('id' => 'form-add', 'role' => 'form','enctype'=>'multipart/from-data'));?>
        <div class="row">
          <div class="col-md-12">
            <h4>Data User</h4><br>
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <?=form_input('name', $detail->name, array('class' => 'form-control', 'placeholder' => $label['name'], 'id' => 'input-name'));?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <?=form_input('email', $detail->email, array('class' => 'form-control', 'placeholder' => $label['email'], 'id' => 'input-email'));?>
                <div id="error" class="invalid-feedback"></div>
              </div>
            </div>            
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <select class="form-control" name="id_user_grup" id="input-id_user_grup">
                  <option value="<?=$detail->id_user_grup?>" style="display:none;" selected><?=$detail->nama_grup?></option>
